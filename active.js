...
const state = {
    ...
    settings: {
        themeMode: 'dark',
        n8nUrl: 'https://limit01000.app.n8n.cloud/webhook/Aiproejeect215',
        n8nAuthHeader: '',
        googleClientId: ''
    },
    activeChatId: null,
...
function loadSettings() {
    try {
        ...
        // Fallback default url if empty or placeholder in storage
        if (!state.settings.n8nUrl || state.settings.n8nUrl.includes('primary-n8n.domain.com')) {
            state.settings.n8nUrl = 'https://limit01000.app.n8n.cloud/webhook/Aiproejeect215';
        }
    } catch (e) {
